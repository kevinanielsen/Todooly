      ...
      <main className="flex flex-col items-center">
        <form className="w-11/12 md:w-2/3 my-3 transition-all duration-300 motion-reduce:transition-none items-center flex flex-col">
          ...
          <div className="flex items-center justify-between w-full">
            <button className="p-5 rounded-lg text-sm mr-3 w-6/12 dark:text-text text-bkg dark:bg-darker bg-text transition-all duration-300 motion-reduce:transition-none">Log in</button>
            <button className="p-5 rounded-lg text-sm ml-3 w-6/12 dark:text-text text-bkg dark:bg-darker bg-text transition-all duration-300 motion-reduce:transition-none">Sign up</button>
          </div>
        </form>
      </main>
    )
