  ...
  return (
    <main className="transition-all duration-300 motion-reduce:transition-none w-full h-full flex items-center justify-center">
      <div className="w-11/12 md:w-2/3 flex flex-col items-center justify-center transition-all duration-300 motion-reduce:transition-none">
        <h1 className="text-base md:text-lg font-bold text-center text-bg dark:text-text">Welcome to Todooly - Todooly is a work in progress, so expect bugs</h1>
        <h2 className="text-sm md:text-base mt-8 md:mt-16 underline dark:text-text">Links</h2>
        <ul className="flex justify-content items-center md:flex-row flex-col">
